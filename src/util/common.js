...
/**
 * Returns the number of bits set on the given bigint.
 * Seems to be faster than `countBigBits`
 * @param {bigint} bigN
 * @returns {number}
 */
export function countBigBits2(bigN) {
  return (bigN.toString(2).match(/1/g) || []).length;
}
